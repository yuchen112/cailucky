// Cache revision update, restricted to the eight reviewed games.
const fs=require('fs'),path=require('path');process.chdir(path.resolve(__dirname,'..'));
const version='20260920-studio1',games=['magic-bubble','dream-match','fairytale-defense','whack','merge','flappy','dino','mines'];
...
console.log('Updated eight games and website revision to '+version);
