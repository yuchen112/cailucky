...
for(const game of games){const html=fs.readFileSync(path.join(root,'games',game,'index.html'),'utf8');assert(html.includes('studio.css?v=20260920-studio1'));assert(html.includes('studio.js?v=20260920-studio1'));assert(!html.includes('director2'));}
